...
lazy val root = project
  ...
  .settings(
    ...
    usefulTasks := Seq(
      ...
      sbtwelcome.UsefulTask("testAll", "test", "Compile and test all projects in all Scala versions and platforms (beware! it uses a lot of memory and might OOM!)"),
      ...
      sbtwelcome.UsefulTask("ci-2_12", ciCommand("2_12"), "Checks formatting, run tests and compute core library coverage for Scala 2.12"),
      sbtwelcome.UsefulTask("ci-2_13", ciCommand(""), "Checks formatting, run tests and compute core library coverage for Scala 2.13"),
    )
  )
