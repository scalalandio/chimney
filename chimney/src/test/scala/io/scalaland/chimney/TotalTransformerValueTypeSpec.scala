...
class TotalTransformerValueTypeSpec extends ChimneySpec {
  ...
  test("AnyVals with private val and single accessor of different name/type are not considered value classes") {
    ...
    compileErrors("new NotAValueType(100).transformInto[UserName]").check(
    ...
    compileErrors("new NotAValueType(100).transformInto[UserId]").check(
    ...
    compileErrors("""UserName("Batman").transformInto[NotAValueType]""").check(
    ...
    compileErrors("UserId(100).transformInto[NotAValueType]").check(
  ...
  test("AnyVals with private private constructor are not considered value classes") {
    ...
    compileErrors("AlsoNotAValueType.create(100).transformInto[UserName]").check(
    ...
    compileErrors("AlsoNotAValueType.create(100).transformInto[UserId]").check(
    ...
    compileErrors("""UserName("Batman").transformInto[AlsoNotAValueType]""").check(
    ...
    compileErrors("UserId(100).transformInto[AlsoNotAValueType]").check(
