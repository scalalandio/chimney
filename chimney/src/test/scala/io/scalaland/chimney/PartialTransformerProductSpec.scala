...
//
//    val result2 = {
//      implicit val cfg: TransformerConfiguration[
//        TransformerFlags.Enable[TransformerFlags.MacrosLogging, TransformerFlags.Default]
//      ] =
//        TransformerConfiguration.default.enableMacrosLogging
//      Person("John", 10, 140).transformIntoPartial[User]
//    }
