    ...
    test(
      ...
      compileErrors("""(colors2enums.Color.Black: colors2enums.Color).transformIntoPartial[colors1enums.Color]""")
        .check(
          ...
          "io.scalaland.chimney.fixtures.colors1enums.Color (transforming from: matching[io.scalaland.chimney.fixtures.colors2enums.Color.Black.type])",
          "  derivation from black: io.scalaland.chimney.fixtures.colors2enums.Color.Black.type to io.scalaland.chimney.fixtures.colors1enums.Color is not supported in Chimney!",
