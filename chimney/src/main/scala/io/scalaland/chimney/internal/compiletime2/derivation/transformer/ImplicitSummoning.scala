...
/** Hearth-based port of `io.scalaland.chimney.internal.compiletime.derivation.transformer.ImplicitSummoning`.
  *
  ...
  */
private[compiletime2] trait ImplicitSummoning { this: Derivation & hearth.MacroCommons =>
