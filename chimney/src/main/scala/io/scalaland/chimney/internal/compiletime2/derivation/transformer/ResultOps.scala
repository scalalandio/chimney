...
import io.scalaland.chimney.internal.compiletime2.{
...
import io.scalaland.chimney.internal.compiletime2.TransformerDerivationError

/** Hearth-based port of `io.scalaland.chimney.internal.compiletime.derivation.transformer.ResultOps` - 1:1 copy
  * (`DerivationResult` is now MIO-backed, but all the helpers keep their old names and signatures).
  */
private[compiletime2] trait ResultOps { this: Derivation & hearth.MacroCommons =>
