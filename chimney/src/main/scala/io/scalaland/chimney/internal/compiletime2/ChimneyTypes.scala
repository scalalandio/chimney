...
/** Hearth-based port of `io.scalaland.chimney.internal.compiletime.ChimneyTypes` - merges the shared trait and both
  * platform implementations into a single cross-quoted source.
  *
  ...
  */
private[compiletime2] trait ChimneyTypes { this: ChimneyDefinitions & hearth.MacroCommons =>
