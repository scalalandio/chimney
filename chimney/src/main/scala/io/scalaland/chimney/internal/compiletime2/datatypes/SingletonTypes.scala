...
/** Hearth-based port of `io.scalaland.chimney.internal.compiletime.datatypes.SingletonTypes`.
  *
  ...
  */
private[compiletime2] trait SingletonTypes { this: ChimneyDefinitions & hearth.MacroCommons =>
