...
trait DerivedTransformerG[From, FromG, ToG, Modifiers <: HList] {

  def transform(src: FromG, modifiers: Modifiers): ToG
}

object DerivedTransformerG
  ...
  def apply[From, FromG, ToG, Modifiers <: HList](implicit dt: DerivedTransformerG[From, FromG, ToG, Modifiers]): DerivedTransformerG[From, FromG, ToG, Modifiers] = dt
}
...
trait GenericInstances {
  ...
  : DerivedTransformerG[From, FromG, HNil, Modifiers] =
  ...
  (implicit vp: ValueProvider[From, FromG, ToFieldT, Label, Modifiers],
   tailTransformer: DerivedTransformerG[From, FromG, TailToG, Modifiers])
  : DerivedTransformerG[From, FromG, FieldType[Label, ToFieldT] :: TailToG, Modifiers] = {
  ...
  : DerivedTransformerG[From, CNil, ToG, Modifiers] =
  ...
  (implicit cip: CoproductInstanceProvider[ToG, Label, HeadT, Modifiers],
   tailTransformer: DerivedTransformerG[From, TailFromG, ToG, Modifiers])
  : DerivedTransformerG[From, FieldType[Label, HeadT] :+: TailFromG, ToG, Modifiers] =
  ...
  (implicit fromLG: LabelledGeneric.Aux[From, FromG],
   ...
   genTransformer: Lazy[DerivedTransformerG[From, FromG, ToG, Modifiers]])
