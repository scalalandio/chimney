...
object dsl {
  ...
  implicit class TransformerOps[From](val source: From) extends AnyVal {
    ...
    final def transformInto[To](implicit derivedTransformer: DerivedTransformer[From, To, Modifier.enableDefaultValues :: HNil]): To =
  ...
  final class TransformerInto[From, To, Modifiers <: HList](val source: From, val modifiers: Modifiers) {
    ...
    def disableDefaultValues[Modifiers2 <: HList](implicit filterNot: FilterNot.Aux[Modifiers, Modifier.enableDefaultValues, Modifiers2]): TransformerInto[From, To, Modifiers2] =
