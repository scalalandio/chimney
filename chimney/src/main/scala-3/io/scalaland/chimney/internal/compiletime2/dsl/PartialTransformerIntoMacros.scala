package io.scalaland.chimney.internal.compiletime2.dsl

// Hearth-migration (Phase 4): verbatim copy of io.scalaland.chimney.internal.compiletime.dsl.PartialTransformerIntoMacros
// (package rename only - DSL macros use plain platform reflection + public runtime types, no macro-commons/Hearth involved).

import io.scalaland.chimney.dsl.*
import io.scalaland.chimney.internal.compiletime2.dsl.utils.DslMacroUtils
