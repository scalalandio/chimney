...
object TransformerMacros {
  ...
  final def deriveTotalTransformerWithConfig[
    ...
    ((overridesType, flagsType): @unchecked) match {
      case ('[type o <: runtime.TransformerOverrides; o], '[type f <: runtime.TransformerFlags; f]) =>
        new TransformerMacros(quotes)
          .deriveTotalTransformerWithConfig[
            ...
            td.asInstanceOf[Expr[
              TransformerDefinition[From, To, o, f]
            ]]
          )
    }
  }
      ...
      case ('[type o <: runtime.TransformerOverrides; o], '[type f <: runtime.TransformerFlags; f]) =>
        new TransformerMacros(quotes)
          .derivePartialTransformerWithConfig[
            ...
            td.asInstanceOf[Expr[
              PartialTransformerDefinition[From, To, o, f]
            ]]
          )
    }
  }
