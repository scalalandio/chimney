...
final class PartialTransformerDefinition[From, To, Cfg <: TransformerCfg, Flags <: TransformerFlags](
  ...
  def withFieldConst[T, U](selector: To => T, value: U)(implicit
    ...
    macro PartialTransformerDefinitionMacros.withFieldConstImpl[From, To, Cfg, Flags, T, U]
  ...
  def withFieldConstPartial[T, U](selector: To => T, value: partial.Result[U])(implicit
    ...
    macro PartialTransformerDefinitionMacros.withFieldConstPartialImpl[From, To, Cfg, Flags, T, U]
  ...
  def withFieldComputed[T, U](selector: To => T, f: From => U)(implicit
    ...
    macro PartialTransformerDefinitionMacros.withFieldComputedImpl[From, To, Cfg, Flags, T, U]
  ...
  def withFieldComputedPartial[T, U](
    ...
    macro PartialTransformerDefinitionMacros.withFieldComputedPartialImpl[From, To, Cfg, Flags, T, U]
  ...
  def withFieldRenamed[T, U](
    ...
    macro PartialTransformerDefinitionMacros.withFieldRenamedImpl[From, To, Cfg, Flags, T, U]
