...
import io.scalaland.chimney.dsl.{PartialTransformerInto, TransformerSourceFlagsDsl, TransformerTargetFlagsDsl}
...
class PartialTransformerIntoMacros(val c: whitebox.Context) extends utils.DslMacroUtils {
  ...
  def withSourceFlagImpl[
    ...
    val pathFrom = new ApplyFieldNameType {
      def apply[FromPath <: Path: WeakTypeTag]: c.WeakTypeTag[?] =
        weakTypeTag[TransformerSourceFlagsDsl.OfPartialTransformerInto[From, To, Overrides, Flags, FromPath]]
  ...
  def withTargetFlagImpl[
    ...
    val pathTo = new ApplyFieldNameType {
      def apply[ToPath <: Path: WeakTypeTag]: c.WeakTypeTag[?] =
        weakTypeTag[TransformerTargetFlagsDsl.OfPartialTransformerInto[From, To, Overrides, Flags, ToPath]]
