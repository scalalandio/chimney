package io.scalaland.chimney.internal.compiletime2.dsl.utils

// Hearth-migration (Phase 4): verbatim copy of io.scalaland.chimney.internal.compiletime.dsl.utils.DslMacroUtils
