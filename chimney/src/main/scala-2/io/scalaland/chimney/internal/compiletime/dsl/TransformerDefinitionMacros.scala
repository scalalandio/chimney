...
class TransformerDefinitionMacros(val c: whitebox.Context) extends utils.DslMacroUtils {
    ...
    .asInstanceOfExpr(
      new ApplyFieldNameType {
        def apply[ToPath <: Path: WeakTypeTag]: c.WeakTypeTag[?] =
          weakTypeTag[TransformerDefinition[From, To, Const[ToPath, Cfg], Flags]]
  ...
  def withFieldComputedImpl[
    ...
    .asInstanceOfExpr(
      new ApplyFieldNameType {
        def apply[ToPath <: Path: WeakTypeTag]: c.WeakTypeTag[?] =
          weakTypeTag[TransformerDefinition[From, To, Computed[ToPath, Cfg], Flags]]
      }.applyFromSelector(selector)
    )
    ...
    .asInstanceOfExpr(
      new ApplyFieldNameTypes {
        def apply[FromPath <: Path: WeakTypeTag, ToPath <: Path: WeakTypeTag]: c.WeakTypeTag[?] =
          weakTypeTag[TransformerDefinition[From, To, RenamedFrom[FromPath, ToPath, Cfg], Flags]]
  ...
  def withCoproductInstanceImpl[
    ...
    def apply[FixedInstance: WeakTypeTag]: Tree = c.prefix.tree
      .addOverride(f)
      .asInstanceOfExpr[TransformerDefinition[From, To, CaseComputed[Path.Match[FixedInstance, Path.Root], Cfg], Flags]]
  ...
  def withConstructorImpl[
    ...
    def apply[Args <: ArgumentLists: WeakTypeTag]: Tree = c.prefix.tree
      .addOverride(f)
      .asInstanceOfExpr[TransformerDefinition[From, To, Constructor[Args, Path.Root, Cfg], Flags]]
  }.applyFromBody(f)
}
