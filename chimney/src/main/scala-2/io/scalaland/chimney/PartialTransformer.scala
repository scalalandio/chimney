...
object PartialTransformer extends PartialTransformerLowPriorityImplicits1 {
  ...
  /** @since 0.8.0 */
  object AutoDerived extends PartialTransformerAutoDerivedLowPriorityImplicits1 {
  ...
  private[chimney] trait PartialTransformerAutoDerivedLowPriorityImplicits1 { this: AutoDerived.type =>
