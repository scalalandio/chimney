...
class PartialTransformerToCatsDataConversionSpec extends ChimneySpec {
  ...
  group("partial transformer result semigroupal instance") {
  ...
  group("conversion between Validated and partial.Result") {
    ...
    group("failed Result should convert to Invalid") {
